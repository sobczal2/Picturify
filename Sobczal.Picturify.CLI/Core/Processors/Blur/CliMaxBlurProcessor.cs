...
{
    public class CliMaxBlurProcessor : CliProcessor
    {
        public CliMaxBlurProcessor() : base("MaxBlur", "Maximum blur. Sets value of a pixel to maximum value of surrounding pixels in range.")
        {
        }
        ...
        public override Command GetCommand()
        {
                ...
                EdgeBehaviourSelector.Type edgeBehaviour, bool toGrayscale) =>
            {
                ...
                fastImage = fastImage.ExecuteProcessor(
                    new MaxBlurProcessor(new MaxBlurParams(channelSelector, psize, edgeBehaviour)));
