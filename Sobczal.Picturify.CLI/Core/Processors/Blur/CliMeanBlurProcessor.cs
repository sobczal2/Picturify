...
{
    public class CliMeanBlurProcessor : CliProcessor
    {
        public CliMeanBlurProcessor() : base("MeanBlur", "Mean blur. Sets value of a pixel to average of surrounding pixels in range.")
        {
        }
        ...
        public override Command GetCommand()
        {
                ...
                EdgeBehaviourSelector.Type edgeBehaviour, bool toGrayscale) =>
            {
                ...
                fastImage = fastImage.ExecuteProcessor(
                    new MeanBlurProcessor(new MeanBlurParams(channelSelector, psize, edgeBehaviour)));
