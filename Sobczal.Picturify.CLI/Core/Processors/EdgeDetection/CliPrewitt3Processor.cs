...
{
public class CliPrewitt3Processor : CliProcessor
    {
        public CliPrewitt3Processor() : base("Prewitt3", "Edge detection using prewitt operator 3x3 with optional non-maximum suppression.")
        {
        }
            ...
            Command.SetHandler((string input, string output, ChannelSelector channelSelector,
                    ...
                    bool useNonMaxSuppression, bool toGrayscale) =>
                {
                    ...
                    fastImage = fastImage.ExecuteProcessor(
                        new DualOperatorProcessor(new DualOperatorParams(channelSelector, new PrewittOperator3(),
