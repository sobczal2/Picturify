...
{
    public class CliSobelFeldman3Processor : CliProcessor
    {
        public CliSobelFeldman3Processor() : base("SobFel3", "Edge detection using sobel-feldman operator 3x3 with optional non-maximum suppression.")
        {
        }
            ...
            Command.SetHandler((string input, string output, ChannelSelector channelSelector,
                    ...
                    bool useNonMaxSuppression, bool toGrayscale) =>
                {
                    ...
                    fastImage = fastImage.ExecuteProcessor(
                        new DualOperatorProcessor(new DualOperatorParams(channelSelector, new SobelFeldmanOperator3(),
