...
{
    public class CliSobel3Processor : CliProcessor
    {
        public CliSobel3Processor() : base("Sobel3", "Edge detection using sobel operator 3x3 with optional non-maximum suppression.")
        {
        }
            ...
            Command.SetHandler((string input, string output, ChannelSelector channelSelector,
                    ...
                    bool useNonMaxSuppression, bool toGrayscale) =>
                {
                    ...
                    fastImage = fastImage.ExecuteProcessor(
                        new DualOperatorProcessor(new DualOperatorParams(channelSelector, new SobelOperator3(),
