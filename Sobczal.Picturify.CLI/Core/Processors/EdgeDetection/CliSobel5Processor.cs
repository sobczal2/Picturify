...
{
    public class CliSobel5Processor : CliProcessor
    {
        public CliSobel5Processor() : base("Sobel5", "Edge detection using sobel operator 5x5 with optional non-maximum suppression.")
        {
        }
            ...
            Command.SetHandler((string input, string output, ChannelSelector channelSelector,
                    ...
                    bool useNonMaxSuppression, bool toGrayscale) =>
                {
                    ...
                    fastImage = fastImage.ExecuteProcessor(
                        new DualOperatorProcessor(new DualOperatorParams(channelSelector, new SobelOperator5(),
