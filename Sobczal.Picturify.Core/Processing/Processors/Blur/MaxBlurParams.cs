...
{
    /// <summary>
    /// Params class for <see cref="MaxBlurProcessor"/>.
    /// </summary>
    public class MaxBlurParams : ProcessorParams
    {
        /// <summary>
        ...
        public MaxBlurParams(ChannelSelector channelSelector, PSize range, EdgeBehaviourSelector.Type edgeBehaviourType = EdgeBehaviourSelector.Type.Extend, IAreaSelector workingArea = null) : base(workingArea, channelSelector)
        {
