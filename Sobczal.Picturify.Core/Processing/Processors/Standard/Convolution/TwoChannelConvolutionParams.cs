...
namespace Sobczal.Picturify.Core.Processing.Standard
{
    public class TwoChannelConvolutionParams : ProcessorParams
    {
        ...
        public TwoChannelConvolutionParams(ChannelSelector channelSelector, List<float[,]> convolutionMatrixesChannel1, List<float[,]> convolutionMatrixesChannel2, MergeParams.MergingFunc mergingFunc, EdgeBehaviourSelector.Type edgeBehaviourType = EdgeBehaviourSelector.Type.Extend, IAreaSelector workingArea = null) : base(workingArea, channelSelector)
        {
